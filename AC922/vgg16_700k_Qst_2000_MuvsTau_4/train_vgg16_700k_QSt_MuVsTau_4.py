...
sys.path.append('../')
from cnn_common_review.build_and_train import build_and_train_model_2class 
from cnn_common_review.taucnn_models import three_chan_adapter, CNN_vgg16

model_name = 'vgg16_700k_QSt2000_dataset_norm_MuVsTau_4'
