...
python /data/user/dpankova/double_pulse/Make_NewFormat_All_Weights.py  -o NewFormat_NuE_test  -i /data/ana/Cscd/StartingEvents/NuGen_new/NuE/medium_energy/IC86_flasher_p1=0.3_p2=0.0/l2/1/l2_00000001.i3.zst
